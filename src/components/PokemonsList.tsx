...
const PokemonsList = () => {
  ...
  if (isPending && !pokemonsList.length) {
    return (
  ...
  return (
    <>
      ...
      {isPending && (
        <div
          role="status"
          className="animate-pulse flex flex-wrap gap-x-6 gap-y-16 justify-center mt-8"
        >
          <div className="w-60 h-30 px-3 rounded-3xl pt-12 pb-6 justify-center items-center flex flex-col cursor-pointer grow bg-white dark:bg-zinc-300"></div>
        </div>
      )}
    </>
  );
